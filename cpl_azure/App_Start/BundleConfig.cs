...
namespace cpl_azure
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //jQueryDownloader
            // Script Bundles
            //BundleTable.Bundles.Add(new ScriptBundle("~/bundle/jquery").Include("~/Scripts/jquery-2.0.3.js"));
            BundleTable.Bundles.Add(new ScriptBundle("~/Scripts/jquery-ui").Include("~/Scripts/jquery-ui-{version}.js"));
